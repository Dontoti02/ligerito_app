  ...
  return GoRouter(
    ...
    routes: [
            ...
            routes: [
              GoRoute(
                ...
                builder: (context, state) =>
                    const ModuloPlaceholderScreen(nombre: 'home'),
              ),
            ],
          ),
          StatefulShellBranch(
            routes: [
              GoRoute(
                path: '/historial',
                builder: (context, state) =>
                    const ModuloPlaceholderScreen(nombre: 'historial'),
              ),
            ],
          ),
          StatefulShellBranch(
      ...
      GoRoute(
        path: '/carrito',
        builder: (context, state) =>
            const ModuloPlaceholderScreen(nombre: 'carrito'),
      ),
      GoRoute(
        path: '/checkout',
        builder: (context, state) =>
            const ModuloPlaceholderScreen(nombre: 'checkout'),
      ),
      GoRoute(
        path: '/pedido/:id',
        builder: (context, state) =>
